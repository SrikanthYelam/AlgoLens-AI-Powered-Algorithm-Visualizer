...
export function LongestPalindromicSubstringInputForm({ onSubmit, isLoading }: AlgorithmInputFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2">
      <label htmlFor="lp-substring-s" className="text-sm font-medium text-gray-700 dark:text-gray-300">
