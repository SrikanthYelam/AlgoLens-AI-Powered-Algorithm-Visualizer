...
Each step gets a plain-English explanation from Claude, such as:
...
* Official `Anthropic` NuGet package for the Claude integration
...
```
/src
  AlgoLens.Api      — HTTP layer: endpoints, request/response contracts, the Claude explanation service
...
* Additional algorithms beyond the current 8
