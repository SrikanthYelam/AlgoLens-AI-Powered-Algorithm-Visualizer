...
public class FlattenBinaryTreeIterativeTests
{
    private readonly FlattenBinaryTreeIterative _algorithm = new();
    ...
    public void Run_CanonicalExample_FlattensToPreorderChain()
    {
        ...
        var finalState = (FlattenBinaryTreeIterativeState)steps[^1].State;
